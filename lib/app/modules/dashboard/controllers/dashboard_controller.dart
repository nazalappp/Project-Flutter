...
import 'package:project2/app/data/entertainment_response.dart';
import 'package:project2/app/data/headline_response.dart';
import 'package:project2/app/data/sports_response.dart';
import 'package:project2/app/data/technology_response.dart';
...
class DashboardController extends GetxController {
  ...
  Future<SportsResponse> getSports() async {
    final response = await _getConnect.get(BaseUrl.sport);
